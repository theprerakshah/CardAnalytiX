...
public class HtmlToText {
    ...
    public static void main(String[] args) {
        ...
        JSONObject canadianRebatesSelectors = jsonObject.getJSONObject("selectors")
                .getJSONObject("greatCanadianRebates");
        ...
        try {
            List<Path> htmlFiles = Files.walk(Paths.get(inputDirectory))
            ...
            for (Path htmlFile : htmlFiles) {
                ...
                for (int i = 0; i < tdCardNameElements.size(); i++) {
                    String rawCardName = tdCardNameElements.size() > i ? tdCardNameElements.get(i).text()
                            : "No Card Name";
                    String productInfo = tdProductInfoElements.size() > i ? tdProductInfoElements.get(i).text()
                            : "No Product Info";
                ...
                for (int i = 0; i < scotiaCardNameElements.size(); i++) {
                    String cardName = scotiaCardNameElements.size() > i ? scotiaCardNameElements.get(i).text()
                            : "No Card Name";
                ...
                for (int i = 0; i < rebateCardNameElements.size(); i++) {
                    String cardName = rebateCardNameElements.size() > i ? rebateCardNameElements.get(i).text()
                            : "No Card Name";
                    String annualFee = rebateAnnualFeeElements.size() > i ? rebateAnnualFeeElements.get(i).text()
                            : "No Annual Fee";
                    String interestRates = rebateInterestRateElements.size() > i
                            ? rebateInterestRateElements.get(i).text()
                            : "No Interest Rates";
                    String additionalFeatures = rebateAdditionalFeaturesElements.size() > i
                            ? rebateAdditionalFeaturesElements.get(i).text()
                ...
                for (int i = 0; i < cibcCardNameElements.size(); i++) {
                    String cardName = cibcCardNameElements.size() > i ? cibcCardNameElements.get(i).text()
                            : "No Card Name";
                    String annualFee = cibcAnnualFeeElements.size() > i ? cibcAnnualFeeElements.get(i).text()
                            : "No Annual Fee";
                    String interestRates = cibcInterestRateElements.size() > i ? cibcInterestRateElements.get(i).text()
                            : "No Interest Rates";
                    String additionalFeatures = cibcAdditionalFeaturesElements.size() > i
                            ? cibcAdditionalFeaturesElements.get(i).text()
                            : "No Additional Features";
                ...
                for (int i = 0; i < nationalBankCardNameElements.size(); i++) {
                    String cardName = nationalBankCardNameElements.size() > i
                            ? nationalBankCardNameElements.get(i).text()
                            : "No Card Name";
                    String annualFee = nationalBankAnnualFeeElements.size() > i
                            ? nationalBankAnnualFeeElements.get(i).text()
                            : "No Annual Fee";
                    String purchaseInterestRate = nationalBankInterestRateElements.size() > i
                            ? nationalBankInterestRateElements.get(i).text()
                            : "No Purchase Interest Rate";
                    String cardType = nationalBankCardTypeElements.size() > i
                            ? nationalBankCardTypeElements.get(i).text()
                            : "No Card Type";
                    String additionalFeatures = nationalBankAdditionalFeaturesElements.size() > i
                            ? nationalBankAdditionalFeaturesElements.get(i).text()
                            : "No Additional Features";
                    ...
                    nationalBankExtractedText.append("Purchase Interest Rate: ").append(purchaseInterestRate)
                            .append(" | ");
