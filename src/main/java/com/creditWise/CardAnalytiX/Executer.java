...
public class Executer {
    ...
    public static void main(String[] args) {
        ...
        String annualFeeRange = getMandatoryInput(
                scanner,
                "2. What is your preferred annual fee range? (For example: $0-$50, $50-$100, $100+): "
        );
        while (!Validation.isValidAnnualFeeRange(annualFeeRange)) {
            System.out.println("Invalid annual fee range format. Please try again.");
            annualFeeRange = getMandatoryInput(
                scanner,
                "2. What is your preferred annual fee range? (For example: $0-$50, $50-$100, $100+): "
            );
        }
